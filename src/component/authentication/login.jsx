...
export const Login = () => {
    ...
    return (
        <>
            <section className="h-[60vh] w-[30%] mx-auto mt-[20px] rounded-md px-[20px] text-black py-[25px] border border-transparent bg-[#a1b7c4d2] " >
                ...
                <form className="h-[60%] w-full mt-[30px] ">
                    ...
                    <button className={`h-[auto] w-[72%] rounded bg-[blue] border border-blue-800 my-[15px] text-white text-[24px] font-semibold ${isdisable ? "bg-[#34343d] ":"bg-[blue]"} ${isdisable? "cursor-not-allowed":"cursor-pointer"} `} disabled={isdisable} >SUBMIT</button>
