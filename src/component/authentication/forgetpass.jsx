...
export const Forgetpass = () => {
    ...
    return (
        <>
            <section className="h-auto w-[40%] bg-[#74748a] px-[20px] py-[20px] mx-auto my-[20px] text-black ">
                ...
                <form>
                    ...
                    <input type="email" className="h-auto w-[70%] border border-transparent outline-none px-[8px] py-1 bg-[#ffffff94] rounded-sm text-black shadowinp hover:border-black " placeholder="Enter email" name="email" value={email.email} onChange={handleemail} required/><br />
                    <button className="h-auto w-auto px-2 py-1 border border-transparent hover:scale-95 bg-blue-600 hover:border-black rounded-sm mx-2 text-white text-[17px] font-semibold mt-2 " onClick={handleotpbtn} >SENT OTP</button>
                    <div className={`h-auto ${otpshow? "block":"hidden"} `} >
                        <label htmlFor="otp">Enter OTP:</label><br />
                        <input type="text" name="otp" value={otpvalue.otp} onChange={handleotpvalue} className="h-auto w-[70%] border border-transparent outline-none px-[8px] py-1 bg-[#ffffff94] rounded-sm text-black shadowinp hover:border-black " /><br />
                        <button className="h-auto w-auto px-2 py-1 border border-transparent hover:scale-95 bg-blue-600 hover:border-black rounded-sm mx-2 text-white text-[17px] font-semibold mt-[8px] " onClick={handleotpsubmit} >SUBMIT</button>
                        <div className={`h-auto ${showpass?"block":"hidden"} `}>
                            ...
                            <button className="h-auto w-auto px-2 py-1 border border-transparent hover:scale-95 bg-blue-600 hover:border-black rounded-sm mx-2 text-white text-[17px] font-semibold mt-2 " onClick={handlefrgsub} >SUBMIT</button>
                        </div>
                    </div>
                </form>
            </section>
