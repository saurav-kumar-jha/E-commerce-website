...
export const Productsection = () => {
    ...
    return (
        <>
            <h1 className="text-lg mx-2 my-3 text-red-600 "><NavLink to="/" >home</NavLink>/<NavLink>product</NavLink> </h1>
            <ul className="flex flex-wrap  mx-auto  w-[100vw] md:w-[80vw] justify-center md:mx-auto">
                {
                    productsList.map((index) => (
                        <li key={index.id} className="h-[auto] min-h-[300px] max-h-[400px] flex hover:scale-105 overflow-hidden cursor-pointer duration-200 shadow-xl md:w-[70%] w-[90%] px-4 pt-4 border rounded bg-[#cbccc0b6] text-black  m-3 justify-between "  >
